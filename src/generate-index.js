...
<title>PeaceGrappler — Reports</title>
<style>
  :root {
    --bg: #0f1117;
    --card: #1a1d27;
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .va-header {
    display: grid;
    grid-template-columns: 110px auto 1fr auto auto auto auto;
  ...
  .va-spacer { /* takes the 1fr column to push buttons right */ }
  .va-toggle {
...
<div class="container">
  ...
  <div class="section">
    ...
    <p style="color: var(--muted); font-size: 14px; margin-bottom: 16px;">
      Daily analysis of new reels — engagement scores, watch time, and growth recommendations.
    </p>
    ${analyses.map((a, i) => {
...
function toggleVA(id, btn) {
  ...
  console.log(`Index page generated: ${outputPath}`);
}
