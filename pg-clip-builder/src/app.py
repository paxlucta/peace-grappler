...
def inject_scripts(response):
    ...
    if (response.content_type
        ...
        # Read each request — picks up brand/handle/domain edits without
        # requiring a restart.
        brand_blob = (
            "<script>window.PG_APP = " + _json.dumps({
                "brand": cfg["brand_name"],
                "handle": cfg["social_handle"],
                "domain": cfg["content_domain"],
            }) + ";</script>"
        )
