...
window.pgAiBadge = function(provider, opts) {
  ...
  var title = (opts && opts.title) || ('Generated by ' + b.label);
  return '<span class="pg-ai-badge" title="' + title + '" style="display:inline-flex;'
    + 'width:' + size + 'px;height:' + size + 'px;vertical-align:middle;'
    + 'flex-shrink:0;line-height:0;">' + b.svg + '</span>';
};
</script>
