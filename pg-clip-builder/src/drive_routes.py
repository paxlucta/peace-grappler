...
def drive_auto_folders():
    """Find-or-create the default PeaceGrappler folders in Drive."""
    try:
...
<main>
  ...
  <div id="connect-card" class="card">
    ...
    <p class="muted">
      ...
      <code class="path">PeaceGrappler Inbox</code> (drop source videos here)
      and <code class="path">PeaceGrappler Output</code> (generated videos
      land here).
    </p>
    <div class="row">
