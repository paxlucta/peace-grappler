...
REPO_HTTPS = "https://github.com/abghandour/clip-builder.git"
...
def check_for_updates():
    ...
    try:
        # Find the git repo root (may be parent of clip-builder)
        ...
        if not git_root:
            ...
            git_root = str(ROOT_DIR)  # the clip-builder repo root itself
            subprocess.run(
